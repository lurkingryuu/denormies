...
from app.models import Accomodation, Competition, Mess, Prize, Sponsor, Sponsorship, User, Student, Participant, Event, Venue
import uuid
import hashlib
import datetime
...
events_data = [
    {'id': '1', 'name': 'Guest Lecture', 'type': 'seminar', 'desc': 'Introductory Seminar by honorable Guest Mr. Sundar Pichai', 'date': '2024-04-15 10:00:00', 'duration': '01:00:00', 'venue': 'Netaji Auditorium'},
    {'id': '2', 'name': 'Overnite', 'type': 'competition', 'desc': 'Competitive Programming Competition held by codeclub', 'date': '2024-04-15 20:00:00', 'duration': '20:00:00', 'venue': 'Takshashila'},
    {'id': '3', 'name': 'Maths Olympiad', 'type': 'competition', 'desc': 'Paper-based mcq test on Maths, Aptitude and Mental Ability', 'date': '2024-04-16 10:00:00', 'duration': '02:00:00', 'venue': 'Vikramshila'},
    {'id': '4', 'name': 'Valorant', 'type': 'competition', 'desc': 'Valorant gaming competition which has to be registered with a team', 'date': '2024-04-16 19:00:00', 'duration': '01:30:00', 'venue': 'Gymkhana'},
    {'id': '5', 'name': 'Musical Concert', 'type': 'concert', 'desc': 'Annual music concert featuring local bands', 'date': '2024-04-17 20:00:00', 'duration': '02:00:00', 'venue': 'MG Grounds'}
]
...
sponsors_data = [
    ...
    {'id': '3', 'name': 'Google', 'desc': 'Multinational technology company specializing in internet-related services.'},
    {'id': '4', 'name': 'Riot Games', 'desc': 'Video game developer and esports tournament organizer.'},
    {'id': '5', 'name': 'Samsung', 'desc': 'Multinational Android device manufacturer.'}
]
...
async def populate_data(session):
    async with session.begin():
        ...
        for accomodation in accomodations_data:
            accomodation["id"] = convert_to_uuid(
                accomodation["id"]
            )
        ...
        for participant in participant_data:
            ...
            participant["mess_id"] = convert_to_uuid(
                participant["mess_id"]
            )
        ...
        for sponsorship in sponsorships_data:
            sponsorship["sponsor_id"] = convert_to_uuid(
        ...
        for prize in prizes_data:
            ...
            prize["winner_id"] = convert_to_uuid(
                prize["winner_id"]
            ) if prize["winner_id"] else None
